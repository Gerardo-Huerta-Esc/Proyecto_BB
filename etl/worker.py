...
#     #subprocess.run(["python3", f"/etl/{script_name}"], check=True)
...
#                 if step == "stage":
#                     run_script("stage.py")
#                     channel.basic_publish(exchange="", routing_key=QUEUE_NAME, body="clean")
#                 elif step == "clean":
#                     run_script("clean.py")
#                     channel.basic_publish(exchange="", routing_key=QUEUE_NAME, body="agg")
#                 elif step == "agg":
#                     run_script("agg.py")
